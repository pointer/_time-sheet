              ...
              <v-container>
                <v-row>
                  <v-text-field
                    ...
                    :label="$t('dataTable.NEW_MESSAGE_SUBJECT')"
                    :data-vv-as="$t('dataTable.NEW_MESSAGE_SUBJECT')"
                    :error-messages="errorMessages"
                    autocomplete="off"
                  ></v-text-field>
                </v-row>
                <v-row>
                  <v-textarea
                    ...
                    name="messageText"
                    v-model="messageText"
                    :label="$t('dataTable.NEW_MESSAGE_TEXT')"
                    :data-vv-as="$t('dataTable.NEW_MESSAGE_TEXT')"
                    :error-messages="errorMessages"
                    autocomplete="off"
                  ></v-textarea>
                </v-row>
...
export default {
  ...
  computed: {
    ...
    businesses() {
      // console.log(this.$store.state.adminBusinesses.businesses)
    ...
    items() {
      return this.$store.state.adminAgents.agents
    },
    totalItems() {
      return this.$store.state.adminAgents.totalAgents
    },
    // confirm: {
    //   get() {
    //     return this.visible
