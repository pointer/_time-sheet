              ...
              <v-container>
                <v-row>
                  <template v-if="editedItem._id">
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <label for="updatedAt">"MAJ le"</label>
                      <div name="updatedAt">
              ...
              <v-container>
                <v-row>
                  <v-text-field
                    ...
                    :label="NEW_MESSAGE_SUBJECT"
                    :data-vv-as="NEW_MESSAGE_SUBJECT"
                    :error-messages="errorMessages"
                    autocomplete="off"
                  ></v-text-field>
                </v-row>
                <v-row>
                  <v-textarea
                    ...
                    name="messageText"
                    v-model="messageText"
                    :label="NEW_MESSAGE_TEXT"
                    :data-vv-as="NEW_MESSAGE_TEXT"
                    :error-messages="errorMessages"
                    autocomplete="off"
                  ></v-textarea>
                </v-row>
...
export default {
  ...
  computed: {
    ...
    formTitle() {
      return this.editedItem._id ? "EDIT_ITEM" : "NEW_ITEM";
    },
    headers() {
      return [
        {
